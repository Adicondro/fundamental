...
public class Main {
    public static void main(String[] args) {
        ...
        // Akan berguna jika membuat list hero, tinggal buat array -> tampilkan -> bisa menghitung hero
        ...
        // Kecuali kalau di declare Hero = new Heroblab, atau Heroblabla = new Heroblabla("")
        // DAN TANPA DI CASTING KE HERO
